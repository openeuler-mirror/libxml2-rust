...
fn UPPER(mut ctxt: htmlParserCtxtPtr) -> libc::c_int {
    ...
    if ::std::mem::size_of::<xmlChar>() as libc::c_ulong >
        ...
        unsafe {
            __res =
                *(*__ctype_toupper_loc_safe()).offset(*(*(*ctxt).input).cur as
                    libc::c_int as isize)
        }
    }
    __res
...
fn GROW(mut ctxt: htmlParserCtxtPtr) {
    let mut ctxtPtr = unsafe { &mut *ctxt };
    if ctxtPtr.progressive == 0 as libc::c_int &&
        SHRINK_bool2(ctxt, INPUT_CHUNK as libc::c_long) {
...
fn UPP(ctxt: htmlParserCtxtPtr, val: libc::c_int) -> libc::c_int {
    ...
    if ::std::mem::size_of::<xmlChar>() as
        ...
        if 0 != 0 {
            let mut __c: libc::c_int =
                unsafe { *inputPtr.cur.offset(val as isize) }
                    as libc::c_int;
            __res =
                (if __c < -(128 as libc::c_int) ||
                    __c > 255 as libc::c_int {
            ...
            unsafe {
                __res =
                    toupper(*inputPtr.cur.offset(val as isize)
                        as libc::c_int)
            }
        }
    } else {
        unsafe {
            __res =
                *(*__ctype_toupper_loc_safe()).offset(*inputPtr.cur.offset(val
...
fn htmlnamePush(mut ctxt: htmlParserCtxtPtr,
    ...
    if ctxtPtr.nameNr >= ctxtPtr.nameMax {
        ...
        ctxtPtr.nameTab =
            xmlRealloc_safe(ctxtPtr.nameTab as
                                *mut *mut xmlChar
                                as
                                *mut libc::c_void,
                            (ctxtPtr.nameMax as
...
fn htmlnamePop(mut ctxt: htmlParserCtxtPtr)
    ...
    if ctxtPtr.nameNr > 0 as libc::c_int {
        unsafe {
            ctxtPtr.name =
                *ctxtPtr.nameTab.offset((ctxtPtr.nameNr - 1 as libc::c_int) as
                    isize)
        }
...
fn htmlNodeInfoPush(mut ctxt: htmlParserCtxtPtr,
    ...
    if ctxtPtr.nodeInfoNr >= ctxtPtr.nodeInfoMax {
        ...
        ctxtPtr.nodeInfoTab =
            xmlRealloc_safe(ctxtPtr.nodeInfoTab
                                as
                            ...
                            (ctxtPtr.nodeInfoMax
                                as
                                libc::c_ulong).wrapping_mul(::std::mem::size_of::<xmlParserNodeInfo>()
                                as
                                libc::c_ulong))
    ...
    unsafe {
        ctxtPtr.nodeInfo =
            &mut *ctxtPtr.nodeInfoTab.offset(ctxtPtr.nodeInfoNr as isize) as
...
fn htmlNodeInfoPop(mut ctxt: htmlParserCtxtPtr)
    ...
    if ctxtPtr.nodeInfoNr > 0 as libc::c_int {
        unsafe {
            ctxtPtr.nodeInfo =
                &mut *ctxtPtr.nodeInfoTab.offset((ctxtPtr.nodeInfoNr -
                    1 as libc::c_int) as isize)
                    as *mut xmlParserNodeInfo
        }
    } else { ctxtPtr.nodeInfo = 0 as *mut xmlParserNodeInfo }
    unsafe {
        return &mut *ctxtPtr.nodeInfoTab.offset(ctxtPtr.nodeInfoNr as isize) as
            *mut xmlParserNodeInfo;
    }
}
/* *
...
fn htmlFindEncoding(mut ctxt: xmlParserCtxtPtr)
    ...
    while cur_safe as libc::c_int >= 'A' as i32 &&
        cur_safe as libc::c_int <= 'Z' as i32 ||
        cur_safe as libc::c_int >= 'a' as i32 &&
            cur_safe as libc::c_int <= 'z' as i32 ||
        cur_safe as libc::c_int >= '0' as i32 &&
            cur_safe as libc::c_int <= '9' as i32 ||
...
fn htmlCurrentChar(mut ctxt: xmlParserCtxtPtr,
    ...
    if ctxtPtr.charset != XML_CHAR_ENCODING_UTF8 as libc::c_int {
        ...
        if guess.is_null() {
            ...
            handler =
                xmlFindCharEncodingHandler_safe(guess as
                    *const libc::c_char);
            if !handler.is_null() {
                /*
                ...
                if xmlStrEqual_safe(handlerPtr.name as
                                        *mut xmlChar,
                ...
                if !(*cur.offset(1 as libc::c_int as isize) as libc::c_int &
                    ...
                    if c as libc::c_int & 0xe0 as libc::c_int ==
                        ...
                        if *cur.offset(2 as libc::c_int as isize) as libc::c_int &
                            ...
                            0xf0 as libc::c_int {
                            if *cur.offset(3 as libc::c_int as isize) as
                            ...
                            if c as libc::c_int & 0xf8 as libc::c_int !=
                                0xf0 as libc::c_int ||
                                *cur.offset(3 as libc::c_int as isize) as
                        ...
                        _ => {
                            if if val < 0x100 as libc::c_int as libc::c_uint {
                                ...
                                (0x100 as libc::c_int as libc::c_uint <= val &&
                                    val <=
                                        0xd7ff as libc::c_int as libc::c_uint
                                    ||
                                    0xe000 as libc::c_int as libc::c_uint <=
                                        val &&
                                        val <=
                                            0xfffd as libc::c_int as
                                                libc::c_uint ||
                                    0x10000 as libc::c_int as libc::c_uint <=
                                        val &&
                                        val <=
                                            0x10ffff as libc::c_int as
     ...
     */
        ...
        unsafe {
            if inputPtr.end.offset_from(inputPtr.cur) as
     ...
     */
        unsafe {
            if !inputPtr.buf.is_null() &&
                (*inputPtr.buf).encoder.is_null() {
                xmlSwitchEncoding_safe(ctxt, XML_CHAR_ENCODING_8859_1);
            }
        }
        unsafe { *len = 1 as libc::c_int; }
    ...
    unsafe {
        return bsearch(tag as *const libc::c_void,
                       ...
                       (::std::mem::size_of::<[htmlElemDesc; 92]>() as
                           libc::c_ulong).wrapping_div(::std::mem::size_of::<htmlElemDesc>()
                           as libc::c_ulong),
                       ::std::mem::size_of::<htmlElemDesc>() as libc::c_ulong,
                       Some(htmlCompareTags as
...
fn htmlGetEndPriority(mut name: *const xmlChar)
    ...
    while !getHtmlEndPriority(i as usize).name.is_null() &&
        xmlStrEqual_safe(getHtmlEndPriority(i as usize).name as
...
extern "C" fn htmlCompareStartClose(mut vkey: *const libc::c_void,
                                    mut member: *const libc::c_void)
                                    -> libc::c_int {
    let mut key: *const htmlStartCloseEntry =
        vkey as *const htmlStartCloseEntry;
    let mut entry: *const htmlStartCloseEntry =
...
fn htmlCheckAutoClose(mut newtag: *const xmlChar,
                      ...
                      -> libc::c_int {
    let mut key: htmlStartCloseEntry =
        htmlStartCloseEntry {
    ...
    unsafe {
        res =
            bsearch(&mut key as *mut htmlStartCloseEntry as *const libc::c_void,
                    htmlStartClose.as_ptr() as *const libc::c_void,
                    (::std::mem::size_of::<[htmlStartCloseEntry; 251]>() as
                        libc::c_ulong).wrapping_div(::std::mem::size_of::<htmlStartCloseEntry>()
                        as libc::c_ulong),
                    ::std::mem::size_of::<htmlStartCloseEntry>() as libc::c_ulong,
                    Some(htmlCompareStartClose as
                        unsafe extern "C" fn(_: *const libc::c_void,
                                             _: *const libc::c_void)
                                             -> libc::c_int));
    }
...
fn htmlAutoCloseOnClose(mut ctxt: htmlParserCtxtPtr,
    ...
    while xmlStrEqual_safe(newtag, ctxtPtr.name) == 0 {
        ...
        let info_condition = unsafe {
            !info.is_null() &&
                (*info).endTag as libc::c_int == 3 as libc::c_int
        };
        if info_condition {
...
fn htmlAutoClose(mut ctxt: htmlParserCtxtPtr,
    ...
    let mut ctxtPtr = unsafe { &mut *ctxt };
    let mut sax_condition = false;
    while !newtag.is_null() && !ctxtPtr.name.is_null() &&
...
fn htmlCheckImplied(mut ctxt: htmlParserCtxtPtr,
    ...
    if ctxtPtr.nameNr <= 1 as libc::c_int &&
        ...
        while i < ctxtPtr.nameNr {
            unsafe {
                if xmlStrEqual_safe(*ctxtPtr.nameTab.offset(i as
                    isize),
                                    b"body\x00" as *const u8 as
                                        *const libc::c_char as
                                        *mut xmlChar) != 0 {
        ...
        htmlnamePush(ctxt,
                     b"body\x00" as *const u8 as *const libc::c_char as
                         *mut xmlChar);
        sax_condition = unsafe { !ctxtPtr.sax.is_null() && (*(*ctxt).sax).startElement.is_some() };
        if sax_condition {
            let mut saxPtr = unsafe { &mut *(*ctxt).sax };
...
fn htmlCheckParagraph(mut ctxt: htmlParserCtxtPtr)
    ...
    while !getHtmlNoContentElements(i as usize).is_null() {
        if xmlStrEqual_safe(tag,
                            getHtmlNoContentElements(i as usize) as
                                *mut xmlChar) != 0 {
            htmlAutoClose(ctxt,
                          b"p\x00" as *const u8 as *const libc::c_char as
                              *mut xmlChar);
...
pub fn htmlEntityLookup(mut name:
    ...
    while (i as libc::c_ulong) <
        (::std::mem::size_of::<[htmlEntityDesc; 253]>() as
            libc::c_ulong).wrapping_div(::std::mem::size_of::<htmlEntityDesc>()
            as libc::c_ulong) {
        if xmlStrEqual_safe(name,
                            getHtml40EntitiesTable(i as usize).name as
                                *mut xmlChar) != 0 {
            unsafe {
...
pub fn UTF8ToHtml(mut out: *mut libc::c_uchar,
    ...
    while in_0 < inend {
        ...
        if d < 0x80 as libc::c_int as libc::c_uint {
            ...
            unsafe {
                *outlen =
                    out.offset_from(outstart) as libc::c_long as
                        libc::c_int;
            }
            unsafe {
                *inlen =
                    processed.offset_from(instart) as libc::c_long as
                        libc::c_int;
            }
        ...
        if c < 0x80 as libc::c_int as libc::c_uint {
            unsafe {
                if out.offset(1 as libc::c_int as isize) >=
    ...
    unsafe {
        *outlen =
            out.offset_from(outstart) as libc::c_long as libc::c_int;
    }
    unsafe {
        *inlen =
            processed.offset_from(instart) as libc::c_long as
...
fn htmlNewInputStream(mut ctxt: htmlParserCtxtPtr)
    ...
    input =
        xmlMalloc_safe(::std::mem::size_of::<htmlParserInput>()
            as libc::c_ulong) as
            xmlParserInputPtr;
    if input.is_null() {
        htmlErrMemory(ctxt,
...
fn areBlanks_htmlparser(mut ctxt: htmlParserCtxtPtr,
        ...
        if dtd_condition {
            ...
            if xmlStrcasecmp_safe(dtdPtr.ExternalID,
                                  b"-//W3C//DTD HTML 4.01//EN\x00"
                                      ...
                                      *const libc::c_char as
                                      *mut xmlChar) == 0 ||
                xmlStrcasecmp_safe(dtdPtr.ExternalID,
    ...
    lastChild =
        xmlGetLastChild_safe(ctxtPtr.node as *const xmlNode);
    unsafe {
    ...
    if lastChild.is_null() {
        ...
        if nodePtr.type_0 as libc::c_uint !=
	   ...
	   for all tags "b" allowing PCDATA */
        i = 0 as libc::c_int as libc::c_uint;
        while (i as libc::c_ulong) <
            (::std::mem::size_of::<[*const libc::c_char; 53]>() as
                libc::c_ulong).wrapping_div(::std::mem::size_of::<*const libc::c_char>()
                as libc::c_ulong) {
            if xmlStrEqual_safe(ctxtPtr.name,
                                getAllowPCData(i as usize) as
                                    *mut xmlChar) != 0 {
                return 0 as libc::c_int;
            }
            i = i.wrapping_add(1)
...
pub fn htmlNewDocNoDtD(mut URI:
     ...
     */
    cur =
        xmlMalloc_safe(::std::mem::size_of::<xmlDoc>()
            as libc::c_ulong) as
            xmlDocPtr;
    if cur.is_null() {
    ...
    curPtr.properties =
        XML_DOC_HTML as libc::c_int | XML_DOC_USERBUILT as libc::c_int;
...
fn htmlParseHTMLName(mut ctxt: htmlParserCtxtPtr)
    ...
    if !IS_ASCII_LETTER(CUR(ctxt)) && CUR(ctxt) != '_' as i32 &&
        CUR(ctxt) != ':' as i32 && CUR(ctxt) != '.' as i32 {
        return 0 as *const xmlChar;
    }
    while i < 100 as libc::c_int &&
        (IS_ASCII_LETTER(CUR(ctxt)) || IS_ASCII_DIGIT(CUR(ctxt)) ||
            CUR(ctxt) == ':' as i32 || CUR(ctxt) == '-' as i32 ||
            CUR(ctxt) == '_' as i32 || CUR(ctxt) == '.' as i32) {
        if CUR(ctxt) >= 'A' as i32 &&
            CUR(ctxt) <= 'Z' as i32 {
            loc[i as usize] =
                (CUR(ctxt) + 0x20 as libc::c_int)
                    as xmlChar
        } else {
...
fn htmlParseHTMLName_nonInvasive(mut ctxt:
    ...
    while i < 100 as libc::c_int &&
        ...
        if NXT(ctxt, 1 as libc::c_int + i) >= 'A' as i32 &&
            ...
            loc[i as usize] =
                (NXT(ctxt, 1 as libc::c_int + i) + 0x20 as libc::c_int) as xmlChar
        } else {
            loc[i as usize] =
                NXT(ctxt, 1 as libc::c_int + i) as xmlChar
        }
        i += 1
    }
    let mut ctxtPtr = unsafe { &mut *ctxt };
...
fn htmlParseName(mut ctxt: htmlParserCtxtPtr)
    ...
    if in_0_safe as libc::c_int >= 0x61 as libc::c_int &&
        ...
        if in_0_safe as libc::c_int > 0 as libc::c_int &&
            ...
            unsafe {
                count =
                    in_0.offset_from(inputPtr.cur) as
                        libc::c_long as libc::c_int;
            }
            ret =
                xmlDictLookup_safe(ctxtPtr.dict,
                                   inputPtr.cur, count);
            inputPtr.cur = in_0;
            inputPtr.col += count;
            return ret;
...
fn htmlParseNameComplex(mut ctxt: xmlParserCtxtPtr)
    ...
    while c != ' ' as i32 && c != '>' as i32 && c != '/' as i32 &&
        (IS_LETTER(c, getXmlIsBaseCharGroup()) ||
            IS_DIGIT(c, getXmlIsDigitGroup()) || c == '.' as i32 || c == '-' as i32 ||
            c == '_' as i32 || c == ':' as i32 ||
    ...
    unsafe {
        if (inputPtr.cur.offset_from(inputPtr.base) as
...
fn htmlParseHTMLAttribute(mut ctxt: htmlParserCtxtPtr,
    ...
    buffer =
        xmlMallocAtomic_safe((buffer_size as
            ...
            if CUR(ctxt) == '&' as i32 {
                if NXT(ctxt, 1 as libc::c_int) == '#' as i32 {
                    ...
                    while bits >= 0 as libc::c_int {
                        ...
                        unsafe {
                            *fresh20 =
                                (c >> bits & 0x3f as libc::c_int as libc::c_uint |
                    ...
                    if out.offset_from(buffer) as libc::c_long >
                        ...
                        let mut indx: libc::c_int =
                            out.offset_from(buffer) as libc::c_long as
                                libc::c_int;
                    ...
                    if name.is_null() {
                        ...
                        *fresh21 = '&' as i32 as xmlChar;
                            ...
                            (buffer_size - 100 as libc::c_int) as libc::c_long
                        {
                            let mut indx_0: libc::c_int =
                                out.offset_from(buffer) as libc::c_long
                                    as libc::c_int;
                        ...
                        *fresh22 = '&' as i32 as xmlChar;
                        ...
                        while *cur as libc::c_int != 0 as libc::c_int {
                            if out.offset_from(buffer) as libc::c_long >
                                (buffer_size - 100 as libc::c_int) as
                                    libc::c_long {
                        ...
                        if c_0 < 0x80 as libc::c_int as libc::c_uint {
                            ...
                            *fresh26 =
                            ...
                            out = out.offset(1);
                            *fresh27 =
                                (c_0 >> 12 as libc::c_int &
                                    0xf as libc::c_int as libc::c_uint |
                                    0xe0 as libc::c_int as libc::c_uint) as
                                    xmlChar;
                            bits_0 = 6 as libc::c_int
                        } else {
                            let fresh28 = out;
                            out = out.offset(1);
                            *fresh28 =
                                (c_0 >> 18 as libc::c_int &
                                    0x7 as libc::c_int as libc::c_uint |
                                    0xf0 as libc::c_int as libc::c_uint) as
                                    xmlChar;
                ...
                while bits_1 >= 0 as libc::c_int {
                    ...
                    out = out.offset(1);
                    *fresh34 =
                        (c_1 >> bits_1 & 0x3f as libc::c_int as libc::c_uint |
                            0x80 as libc::c_int as libc::c_uint) as xmlChar;
                    bits_1 -= 6 as libc::c_int
                }
                xmlNextChar_safe(ctxt);
...
fn htmlParseSystemLiteral(mut ctxt: htmlParserCtxtPtr)
    ...
    unsafe {
        startPosition =
            inputPtr.cur.offset_from(inputPtr.base) as
    ...
    if CUR(ctxt) != quote {
        ...
        if err == 0 as libc::c_int {
            unsafe {
                ret =
                    xmlStrndup_safe(inputPtr.base.offset(startPosition
                        as
                        isize),
                                    len as libc::c_int)
            }
...
fn htmlParseScript(mut ctxt: htmlParserCtxtPtr) {
    ...
    if nbchar != 0 as libc::c_int && !ctxtPtr.sax.is_null() &&
...
fn htmlParsePI(mut ctxt: htmlParserCtxtPtr) {
	 ...
	 */
		 ...
		 */
                sax_condition = unsafe {
                    !ctxtPtr.sax.is_null() && ctxtPtr.disableSAX == 0 &&
            ...
            if !IS_BLANK(cur) {
                htmlParseErr(ctxt, XML_ERR_SPACE_REQUIRED,
                             b"ParsePI: PI %s space expected\n\x00" as
                                 *const u8 as *const libc::c_char, target,
                             0 as *const xmlChar);
            }
            htmlSkipBlankChars(ctxt);
            cur = htmlCurrentChar(ctxt, &mut l);
                ...
                if IS_CHAR(cur) {
                    ...
                    htmlParseErrInt(ctxt, XML_ERR_INVALID_CHAR,
                                    b"Invalid char in processing instruction 0x%X\n\x00" as
                                        *const u8 as *const libc::c_char, cur);
                }
                NEXTL(ctxt, l);
                cur = htmlCurrentChar(ctxt, &mut l);
                if cur == 0 as libc::c_int {
...
fn htmlParseComment(mut ctxt: htmlParserCtxtPtr) {
    ...
    if q == 0 {
        htmlParseErr(ctxt, XML_ERR_COMMENT_NOT_FINISHED,
                     b"Comment not terminated \n<!--%.50s\n\x00" as *const u8 as
                         *const libc::c_char, buf, 0 as *const xmlChar);
        xmlFree_safe(buf as *mut libc::c_void);
        return;
    }
    NEXTL(ctxt, ql);
    ...
    NEXTL(ctxt, rl);
    cur = htmlCurrentChar(ctxt, &mut l);
    while (cur != 0 as i32) && ((cur != '>' as i32) || (r != '-' as i32) ||
        (q != '-' as i32)) {
        NEXTL(ctxt, l);
        ...
        if (q == '-' as i32) && (r == '-' as i32) &&
            (cur == '!' as i32) && (next == '>' as i32) {
            htmlParseErr(ctxt, XML_ERR_COMMENT_NOT_FINISHED,
                         b"Comment incorrectly closed by '--!>'\x00" as *const u8 as
                             *const libc::c_char, 0 as *const xmlChar, 0 as *const xmlChar);
            cur = '>' as i32;
            break;
        }
        if (len + 5 as libc::c_int) >= size {
...
pub fn htmlParseCharRef(mut ctxt:
    ...
    if CUR(ctxt) == '&' as i32 &&
        NXT(ctxt, 1 as libc::c_int) == '#' as i32 &&
        (NXT(ctxt, 2 as libc::c_int) == 'x' as i32 ||
            NXT(ctxt, 2 as libc::c_int) == 'X' as i32) {
...
fn htmlParseDocTypeDecl(mut ctxt: htmlParserCtxtPtr) {
    ...
    let mut ctxtPtr = unsafe { &mut *ctxt };
    let mut sax_condition = unsafe {
        !ctxtPtr.sax.is_null() && (*(*ctxt).sax).internalSubset.is_some() &&
            ctxtPtr.disableSAX == 0
    };
    if sax_condition {
        let mut saxPtr = unsafe { &mut *(*ctxt).sax };
...
fn htmlCheckEncodingDirect(mut ctxt: htmlParserCtxtPtr,
    ...
    if !encoding.is_null() {
        ...
        enc =
            xmlParseCharEncoding_safe(encoding as
                *const libc::c_char);
        /*
	 ...
	 */
        if enc as libc::c_int != XML_CHAR_ENCODING_ERROR as libc::c_int {
            ...
            if (enc as libc::c_int == XML_CHAR_ENCODING_UTF16LE as libc::c_int
                ||
                enc as libc::c_int ==
                    XML_CHAR_ENCODING_UTF16BE as libc::c_int ||
                enc as libc::c_int ==
                    XML_CHAR_ENCODING_UCS4LE as libc::c_int ||
                enc as libc::c_int ==
                    XML_CHAR_ENCODING_UCS4BE as libc::c_int) &&
                buf_condition {
                htmlParseErr(ctxt, XML_ERR_INVALID_ENCODING,
	     ...
	     */
            handler =
                xmlFindCharEncodingHandler_safe(encoding as
                    *const libc::c_char);
            if !handler.is_null() {
                xmlSwitchToEncoding_safe(ctxt, handler);
                ctxtPtr.charset = XML_CHAR_ENCODING_UTF8 as libc::c_int
...
fn htmlCheckEncoding(mut ctxt: htmlParserCtxtPtr,
    ...
    unsafe {
        if !encoding.is_null() &&
            IS_BLANK_CH((*encoding) as libc::c_int) {
            encoding =
                xmlStrcasestr_safe(attvalue,
                                   b"=\x00" as *const u8 as
                                       *const libc::c_char as
...
fn htmlCheckMeta(mut ctxt: htmlParserCtxtPtr,
    ...
    while !att.is_null() {
        ...
        if !value.is_null() &&
            xmlStrcasecmp_safe(att,
                               b"http-equiv\x00" as *const u8 as
                                   *const libc::c_char as
                                   *mut xmlChar) == 0 &&
            xmlStrcasecmp_safe(value,
...
fn htmlParseStartTag(mut ctxt: htmlParserCtxtPtr)
    ...
    if xmlStrEqual_safe(name,
        ...
        while indx < ctxtPtr.nameNr {
            unsafe {
                if xmlStrEqual_safe(*ctxtPtr.nameTab.offset(indx as
                    isize),
                                    b"body\x00" as *const u8 as
                                        *const libc::c_char as
                                        *mut xmlChar) != 0 {
                        ...
                        unsafe {
                            match current_block {
                                ...
                                _ => {
                                    ...
                                    nbatts = nbatts + 1;
                                    let ref mut fresh44 =
                                        *atts.offset(fresh43 as isize);
                                    *fresh44 = attname;
                                    let fresh45 = nbatts;
                                    nbatts = nbatts + 1;
                                    let ref mut fresh46 =
                                        *atts.offset(fresh45 as isize);
                                    *fresh46 = attvalue;
                                    let ref mut fresh47 =
...
fn htmlParseEndTag(mut ctxt: htmlParserCtxtPtr)
    ...
    if !ctxtPtr.name.is_null() &&
        xmlStrEqual_safe(ctxtPtr.name, name) == 0 {
        htmlParseErr(ctxt, XML_ERR_TAG_NAME_MISMATCH,
                     b"Opening and ending tag mismatch: %s and %s\n\x00" as
                         *const u8 as *const libc::c_char, name,
                     ctxtPtr.name);
    ...
    if NXT(ctxt, 1 as libc::c_int) == '#' as i32 {
        ...
        if c < 0x80 as libc::c_int as libc::c_uint {
            ...
            out[fresh50 as usize] =
                (c >> 6 as libc::c_int & 0x1f as libc::c_int as libc::c_uint |
                    0xc0 as libc::c_int as libc::c_uint) as xmlChar;
            bits = 0 as libc::c_int
        } else if c < 0x10000 as libc::c_int as libc::c_uint {
            let fresh51 = i;
            ...
            out[fresh51 as usize] =
                (c >> 12 as libc::c_int & 0xf as libc::c_int as libc::c_uint |
                    0xe0 as libc::c_int as libc::c_uint) as xmlChar;
            bits = 6 as libc::c_int
        } else {
            let fresh52 = i;
            ...
            out[fresh52 as usize] =
                (c >> 18 as libc::c_int & 0x7 as libc::c_int as libc::c_uint |
                    0xf0 as libc::c_int as libc::c_uint) as xmlChar;
            bits = 12 as libc::c_int
        }
        while bits >= 0 as libc::c_int {
        ...
        if flag {
            ...
            while bits_0 >= 0 as libc::c_int {
                ...
                out[fresh58 as usize] =
                    (c_0 >> bits_0 & 0x3f as libc::c_int as libc::c_uint |
                        0x80 as libc::c_int as libc::c_uint) as xmlChar;
                bits_0 -= 6 as libc::c_int
            }
...
fn htmlParseContent(mut ctxt: htmlParserCtxtPtr) {
	 ...
	 */
        if CUR(ctxt) == '<' as i32 &&
            ...
            if CUR(ctxt) == '<' as i32 &&
                ...
                if !ctxtPtr.name.is_null() {
                    if htmlCheckAutoClose(name, ctxtPtr.name) ==
                        1 as libc::c_int {
                        htmlAutoClose(ctxt, name);
                        continue;
                    }
	 ...
	 * the next element
	 */
            if ctxtPtr.nameNr > 0 as libc::c_int && depth >= ctxtPtr.nameNr &&
                xmlStrEqual_safe(currentNode, ctxtPtr.name) == 0
            {
                if !currentNode.is_null() {
                    xmlFree_safe(currentNode as
                        *mut libc::c_void);
                }
                return;
            }
...
pub fn htmlParseElement(mut ctxt:
    ...
    if ctxtPtr.record_info != 0 {
        unsafe {
            node_info.begin_pos =
                inputPtr.consumed.wrapping_add(inputPtr.cur.offset_from(inputPtr.base)
                    as libc::c_long as
                    libc::c_ulong);
        }
 ...
 */
    ...
    unsafe {
        if ctxtPtr.encoding.is_null() &&
            inputPtr.end.offset_from(inputPtr.cur) as
                libc::c_long >= 4 as libc::c_int as libc::c_long {
            /*
     ...
     */
            ...
            start[1 as libc::c_int as usize] =
                NXT(ctxt, 1 as libc::c_int) as xmlChar;
            start[2 as libc::c_int as usize] =
                NXT(ctxt, 2 as libc::c_int) as xmlChar;
            start[3 as libc::c_int as usize] =
                NXT(ctxt, 3 as libc::c_int) as xmlChar;
            enc =
                xmlDetectCharEncoding_safe(&mut *start.as_mut_ptr().offset(0
                    as
                    libc::c_int
                    as
                    isize),
 ...
 */
    ...
    sax_condition = unsafe {
        !ctxtPtr.sax.is_null() && (*(*ctxt).sax).startDocument.is_some() &&
            ctxtPtr.disableSAX == 0
    };
    if sax_condition {
        let mut saxPtr = unsafe { &mut *(*ctxt).sax };
 ...
 */
    ...
    if ctxtPtr.options & HTML_PARSE_NODEFDTD as libc::c_int == 0 &&
        ...
        if dtd.is_null() {
            ...
            myDocPtr.intSubset =
                xmlCreateIntSubset_safe(ctxtPtr.myDoc,
                                        b"html\x00" as *const u8 as
                                            *const libc::c_char as
                                            *mut xmlChar,
                                        b"-//W3C//DTD HTML 4.0 Transitional//EN\x00"
...
fn htmlInitParserCtxt(mut ctxt: htmlParserCtxtPtr)
    ...
    sax =
        xmlMalloc_safe(::std::mem::size_of::<htmlSAXHandler>()
            as libc::c_ulong) as
            *mut htmlSAXHandler;
    if sax.is_null() {
        htmlErrMemory(0 as xmlParserCtxtPtr,
    ...
    ctxtPtr.inputTab =
        xmlMalloc_safe((5 as libc::c_int as
            libc::c_ulong).wrapping_mul(::std::mem::size_of::<htmlParserInputPtr>()
            as
            libc::c_ulong))
    ...
    ctxtPtr.nodeTab =
        xmlMalloc_safe((10 as libc::c_int as
            libc::c_ulong).wrapping_mul(::std::mem::size_of::<htmlNodePtr>()
            as
            libc::c_ulong))
            as *mut htmlNodePtr;
...
pub fn htmlNewParserCtxt()
    ...
    ctxt =
        xmlMalloc_safe(::std::mem::size_of::<xmlParserCtxt>()
            as libc::c_ulong) as
            xmlParserCtxtPtr;
    if ctxt.is_null() {
        htmlErrMemory(0 as xmlParserCtxtPtr,
...
pub fn htmlCreateMemoryParserCtxt_htmlparser(mut buffer:
    ...
    buf =
        xmlParserInputBufferCreateMem_safe(buffer, size,
...
fn htmlCreateDocParserCtxt(mut cur: *const xmlChar,
    ...
    ctxt =
        htmlCreateMemoryParserCtxt_safe(cur as *mut libc::c_char,
                                        len);
    if ctxt.is_null() { return 0 as htmlParserCtxtPtr; }
    let mut ctxtPtr = unsafe { &mut *ctxt };
    if !encoding.is_null() {
        ...
        inputPtr.encoding =
            xmlStrdup_safe(encoding as *const xmlChar);
...
fn htmlParseLookupSequence(mut ctxt: htmlParserCtxtPtr,
    ...
    unsafe {
        base =
            in_0Ptr.cur.offset_from(in_0Ptr.base) as libc::c_long as
                libc::c_int;
    }
                ...
                if DEBUG_PUSH != 0 {
                    if next as libc::c_int == 0 as libc::c_int {
                        __xmlGenericError_safe_macro!(__xmlGenericErrorContext_safe(),
                                                                                   b"HPP: lookup '%c' found at %d" as *const u8 as
                                                                                       *const libc::c_char,
        ...
        if next as libc::c_int == 0 as libc::c_int {
            __xmlGenericError_safe_macro!(__xmlGenericErrorContext_safe(),
                                                                           b"HPP: lookup '%c' failed\n" as *const u8 as
                                                                               *const libc::c_char, first as libc::c_uint);
        } else if third as libc::c_int == 0 as libc::c_int {
            __xmlGenericError_safe_macro!(__xmlGenericErrorContext_safe(),
                                                                           b"HPP: lookup '%c%c' failed\n" as *const u8 as
                                                                               *const libc::c_char, first as libc::c_uint, next as libc::c_uint);
        } else {
            __xmlGenericError_safe_macro!(__xmlGenericErrorContext_safe(),
...
fn htmlParseLookupCommentEnd(mut ctxt: htmlParserCtxtPtr)
    ...
    while mark >= 0 as libc::c_int {
        mark =
            htmlParseLookupSequence(ctxt, '-' as i32 as xmlChar,
                                    '-' as i32 as xmlChar,
...
fn htmlParseTryOrFinish(mut ctxt: htmlParserCtxtPtr,
    ...
    loop {
        ...
        if in_0Ptr.buf.is_null() {
            unsafe {
                avail =
                    in_0Ptr.length as libc::c_long -
                        in_0Ptr.cur.offset_from(in_0Ptr.base) as
                            libc::c_long
            }
        } else {
            unsafe {
                avail =
                    xmlBufUse_safe((*(*in_0).buf).buffer) as ptrdiff_t
                        -
                        in_0Ptr.cur.offset_from(in_0Ptr.base) as
                            libc::c_long
            }
        ...
        match ctxtPtr.instate {
            ...
            XML_PARSER_START => {//Very first chars read from the document flow
                ...
                if IS_BLANK_CH(cur as libc::c_int) {
                    ...
                    if in_0Ptr.buf.is_null() {
                        ...
                        unsafe {
                            avail =
                                xmlBufUse_safe((*(*in_0).buf).buffer)
                                    as ptrdiff_t -
                                    in_0Ptr.cur.offset_from(in_0Ptr.base)
                                        as libc::c_long
                        }
            ...
            XML_PARSER_MISC => {
                ...
                unsafe {
                    if cur as libc::c_int == '<' as i32 &&
                        next as libc::c_int == '!' as i32 &&
                        *in_0Ptr.cur.offset(2 as libc::c_int as isize) as
                            libc::c_int == '-' as i32 &&
                        *in_0Ptr.cur.offset(3 as libc::c_int as isize) as
                            libc::c_int == '-' as i32 {
                        if terminate == 0 &&
            ...
            XML_PARSER_EPILOG => {
                ...
                unsafe {
                    if cur as libc::c_int == '<' as i32 &&
                        next as libc::c_int == '!' as i32 &&
                        *in_0Ptr.cur.offset(2 as libc::c_int as isize)
                            as libc::c_int == '-' as i32 &&
                        *in_0Ptr.cur.offset(3 as libc::c_int as isize)
                            as libc::c_int == '-' as i32 {
                        if terminate == 0 &&
                            htmlParseLookupCommentEnd(ctxt) <
                                0 as libc::c_int {
                        ...
                        ctxtPtr.errNo =
                            XML_ERR_DOCUMENT_END as libc::c_int;
            ...
            XML_PARSER_START_TAG => {
                ...
                if ctxtPtr.record_info != 0 {
                    unsafe {
                        node_info.begin_pos =
                            inputPtr.consumed.wrapping_add(
                                inputPtr.cur.offset_from(inputPtr.base)
                                    as
                                    libc::c_long
                                    as
 ...
 */
            ...
            XML_PARSER_CONTENT => {
                let mut chr: [xmlChar; 2] =
                    [0 as libc::c_int as xmlChar,
                        0 as libc::c_int as xmlChar];
                if ctxtPtr.token != 0 as libc::c_int {
                    chr[0 as libc::c_int as usize] =
                        ctxtPtr.token as xmlChar;
                    htmlCheckParagraph(ctxt);
                    sax_condition = unsafe {
                        !ctxtPtr.sax.is_null() && (*(*ctxt).sax).characters.is_some()
                    };
         ...
         */
                    if terminate == 0 {
                        ...
                        unsafe {
                            val =
                                *in_0Ptr.cur.offset((idx + 2 as libc::c_int)
                                    as isize);
                        }
                    ...
                    unsafe {
                        if cur as libc::c_int == '<' as i32 &&
                            ...
                            next as libc::c_int == '!' as i32 &&
                            *in_0Ptr.cur.offset(2 as libc::c_int as
                                isize) as
                                libc::c_int == '-' as i32 &&
                            *in_0Ptr.cur.offset(3 as libc::c_int as
                                isize) as
                                libc::c_int == '-' as i32 {
                            if terminate == 0 &&
                                htmlParseLookupCommentEnd(ctxt) <
    ...
    if ctxtPtr.options & HTML_PARSE_NODEFDTD as libc::c_int == 0 &&
        ...
        (terminate != 0 ||
            ctxtPtr.instate as libc::c_int ==
                XML_PARSER_EOF as libc::c_int ||
            ctxtPtr.instate as libc::c_int ==
                XML_PARSER_EPILOG as libc::c_int) {
        let mut dtd: xmlDtdPtr = 0 as *mut xmlDtd;
        dtd = xmlGetIntSubset_safe(ctxtPtr.myDoc as *const xmlDoc);
        if dtd.is_null() {
            let mut myDocPtr = unsafe { &mut *(*ctxt).myDoc };
...
pub fn htmlParseChunk(mut ctxt:
    ...
    if flag1 {
        ...
        let mut bufPtr = unsafe { &mut *(*(*ctxt).input).buf };
        let mut base: size_t =
            xmlBufGetInputBase_safe(bufPtr.buffer, ctxtPtr.input);
        let mut cur: size_t =
            unsafe {
                inputPtr.cur.offset_from(inputPtr.base)
        ...
        if flag2 {
            ...
            let mut in_0Ptr = unsafe { &mut *in_0 };
            if !in_0Ptr.encoder.is_null() && !in_0Ptr.buffer.is_null() &&
                !in_0Ptr.raw.is_null() {
                let mut nbchars: libc::c_int = 0;
                let mut base_0: size_t =
                    xmlBufGetInputBase_safe(in_0Ptr.buffer, ctxtPtr.input);
...
pub fn htmlCreateFileParserCtxt(mut filename:
    ...
    inputStream =
        xmlLoadExternalEntity_safe(canonicFilename, 0 as *const libc::c_char,
                                   ctxt);
    xmlFree_safe(canonicFilename as
        *mut libc::c_void);
    if inputStream.is_null() {
        xmlFreeParserCtxt_safe(ctxt);
        return 0 as htmlParserCtxtPtr;
    ...
    if !encoding.is_null() {
        ...
        if l < 1000 as libc::c_int as libc::c_ulong {
            content =
                xmlMallocAtomic_safe((xmlStrlen_safe(content_line)
                    as
                    libc::c_ulong).wrapping_add(l).wrapping_add(1
                    as
                    libc::c_int
                    as
                    libc::c_ulong))
        ...
        1 => {
            return if legacy != 0 {
                (if htmlElementAllowedHere(htmlTagLookup(parentPtr.name),
                    ...
                    != 0 {
                    HTML_VALID as libc::c_int
                } else { HTML_INVALID as libc::c_int }) as
                    libc::c_uint
            } else {
...
pub fn htmlCtxtReset(mut ctxt:
    ...
    if !ctxtPtr.spaceTab.is_null() {
        unsafe {
            *ctxtPtr.spaceTab.offset(0 as libc::c_int as isize) =
                -(1 as libc::c_int);
        }
        unsafe {
            ctxtPtr.space =
                &mut *ctxtPtr.spaceTab.offset(0 as libc::c_int as isize) as
                    *mut libc::c_int
        }
    ...
    if !ctxtPtr.version.is_null() &&
        (dict.is_null() ||
            xmlDictOwns_safe(dict, ctxtPtr.version) ==
                0 as libc::c_int) {
        xmlFree_safe(ctxtPtr.version as
            *mut libc::c_char as
            *mut libc::c_void);
    }
    ctxtPtr.version = 0 as *const xmlChar;
    if !ctxtPtr.encoding.is_null() &&
        (dict.is_null() ||
            xmlDictOwns_safe(dict, ctxtPtr.encoding) ==
                0 as libc::c_int) {
        xmlFree_safe(ctxtPtr.encoding as
            *mut libc::c_char as
            *mut libc::c_void);
    }
    ctxtPtr.encoding = 0 as *const xmlChar;
    if !ctxtPtr.directory.is_null() &&
        (dict.is_null() ||
            xmlDictOwns_safe(dict,
                             ctxtPtr.directory as
                                 *const xmlChar) ==
                0 as libc::c_int) {
        xmlFree_safe(ctxtPtr.directory as
            *mut libc::c_void);
    }
    ctxtPtr.directory = 0 as *mut libc::c_char;
    if !ctxtPtr.extSubURI.is_null() &&
        (dict.is_null() ||
            xmlDictOwns_safe(dict,
                             ctxtPtr.extSubURI as
                                 *const xmlChar) ==
                0 as libc::c_int) {
        xmlFree_safe(ctxtPtr.extSubURI as
            *mut libc::c_char as
            *mut libc::c_void);
    }
    ...
    if !ctxtPtr.extSubSystem.is_null() &&
        (dict.is_null() ||
            xmlDictOwns_safe(dict,
                             ctxtPtr.extSubSystem as
                                 *const xmlChar) ==
                0 as libc::c_int) {
        xmlFree_safe(ctxtPtr.extSubSystem as
            *mut libc::c_char as
            *mut libc::c_void);
    }
...
fn htmlDoRead(mut ctxt: htmlParserCtxtPtr,
    ...
    if !encoding.is_null() {
        ...
        if !hdlr.is_null() {
            ...
            inputPtr.encoding =
                xmlStrdup_safe(encoding as *mut xmlChar)
        }
    }
    let mut flag = unsafe {
        !URL.is_null() && !ctxtPtr.input.is_null() &&
            (*(*ctxt).input).filename.is_null()
    };
    if flag {
        let mut inputPtr = unsafe { &mut *(*ctxt).input };
        inputPtr.filename =
            xmlStrdup_safe(URL as *const xmlChar) as
                *mut libc::c_char
    }
    htmlParseDocument(ctxt);
    ret = ctxtPtr.myDoc;
    ...
    if reuse == 0 {
        unsafe {
            if ctxtPtr.dictNames != 0 && !ret.is_null() &&
                (*ret).dict == ctxtPtr.dict {
...
pub fn htmlReadFd(mut fd: libc::c_int,
    ...
    xmlInitParser_safe();
    input =
        xmlParserInputBufferCreateFd_safe(fd,
                                          XML_CHAR_ENCODING_NONE);
    ...
    stream =
        xmlNewIOInputStream_safe(ctxt, input,
                                 XML_CHAR_ENCODING_NONE);
    if stream.is_null() {
        xmlFreeParserInputBuffer_safe(input);
        xmlFreeParserCtxt_safe(ctxt);
...
pub fn htmlReadIO(mut ioread:
    ...
    xmlInitParser_safe();
    input =
        xmlParserInputBufferCreateIO_safe(ioread, ioclose, ioctx,
                                          XML_CHAR_ENCODING_NONE);
    if input.is_null() {
        if ioclose.is_some() {
...
pub fn htmlCtxtReadFile(mut ctxt:
    ...
    htmlCtxtReset(ctxt);
    stream =
        xmlLoadExternalEntity_safe(filename,
