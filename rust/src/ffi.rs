...
extern{
    ...
    fn __xmlRaiseError(schannel: xmlStructuredErrorFunc,
                       ...
                       msg: *const libc::c_char, more_params: ...);
    #[no_mangle]
    ...
    #[no_mangle]
    fn __xmlLoaderErr(ctx: *mut libc::c_void, msg: *const libc::c_char,
                      filename: *const libc::c_char);
    #[no_mangle]
    fn snprintf(arg1: *mut libc::c_char, arg2: libc::c_ulong,
                arg3: *const libc::c_char, more_params: ...) -> libc::c_int;
    #[no_mangle]
    ...
    #[no_mangle]
    fn xmlHashDefaultDeallocator(entry: *mut libc::c_void,
                                 name: *const xmlChar);
    #[no_mangle]
    fn xmlParserValidityError(ctx: *mut libc::c_void,
                              msg: *const libc::c_char, _: ...);
    #[no_mangle]
    fn xmlParserValidityWarning(ctx: *mut libc::c_void,
                                msg: *const libc::c_char, _: ...);
    #[no_mangle]
    ...
    fn xmlCharEncCloseFunc(handler: *mut xmlCharEncodingHandler)
                           -> libc::c_int;
    #[no_mangle]
    fn xmlParserInputBufferCreateFilename(URI: *const libc::c_char,
                                          enc: xmlCharEncoding)
    ...
    #[no_mangle]
    fn xmlParserGetDirectory(filename: *const libc::c_char)
                             -> *mut libc::c_char;
    #[no_mangle]
    ...
    #[no_mangle]
    fn xmlSAX2IgnorableWhitespace(ctx: *mut libc::c_void, ch: *const xmlChar,
                                  len: libc::c_int);
    #[no_mangle]
    ...
    #[no_mangle]
    fn xmlSAXVersion(hdlr: *mut xmlSAXHandler, version: libc::c_int)
                     -> libc::c_int;
    #[no_mangle]
    ...
    #[no_mangle]
    fn xmlLoadExternalEntity(URL: *const libc::c_char,
                             ID: *const libc::c_char, ctxt: xmlParserCtxtPtr)
                             -> xmlParserInputPtr;
    #[no_mangle]
    fn xmlCharInRange(val: libc::c_uint, group: *const xmlChRangeGroup)
                      -> libc::c_int;
    #[no_mangle]
    ...
    fn xmlCharEncFirstLineInput(input: xmlParserInputBufferPtr,
                                len: libc::c_int) -> libc::c_int;
    #[no_mangle]
    fn xmlCharEncInput(input: xmlParserInputBufferPtr, flush: libc::c_int)
                       -> libc::c_int;
    #[no_mangle]
 ...
 */
    ...
    #[no_mangle]
    fn xmlInputReadCallbackNop(context: *mut libc::c_void,
 ...
 */
    ...
    fn xmlAllocParserInputBuffer(enc: xmlCharEncoding)
                                 -> xmlParserInputBufferPtr;
    #[no_mangle]
    fn xmlParserInputBufferCreateFd(fd: libc::c_int, enc: xmlCharEncoding)
                                    -> xmlParserInputBufferPtr;
    #[no_mangle]
    fn xmlParserInputBufferCreateMem(mem: *const libc::c_char,
 ...
 */
    #[no_mangle]
    fn xmlDictLookup(dict: xmlDictPtr, name: *const xmlChar, len: libc::c_int)
                     -> *const xmlChar;
    #[no_mangle]
 ...
 */
    ...
    #[no_mangle]
    fn xmlSplitQName3(name: *const xmlChar, len: *mut libc::c_int)
                      -> *const xmlChar;
    #[no_mangle]
    ...
    #[no_mangle]
    fn xmlBufferAdd(buf: xmlBufferPtr, str: *const xmlChar, len: libc::c_int)
                    -> libc::c_int;
    /*
 ...
 */
    ...
    #[no_mangle]
    fn xmlHashCreateDict(size: libc::c_int, dict: xmlDictPtr)
                         -> xmlHashTablePtr;
    #[no_mangle]
    ...
    #[no_mangle]
    fn xmlFindCharEncodingHandler(name: *const libc::c_char)
                                  -> xmlCharEncodingHandlerPtr;
    /*
 * Interfaces directly used by the parsers.
 */
    #[no_mangle]
    fn xmlDetectCharEncoding(in_0: *const libc::c_uchar, len: libc::c_int)
                             -> xmlCharEncoding;
    #[no_mangle]
    fn xmlCleanupMemory();
    #[no_mangle]
 ...
 */
    ...
    #[no_mangle]
    fn xmlSAX2GetEntity(ctx: *mut libc::c_void, name: *const xmlChar)
                        -> xmlEntityPtr;
    #[no_mangle]
    fn xmlSAX2StartElement(ctx: *mut libc::c_void, fullname: *const xmlChar,
    ...
    #[no_mangle]
    fn xmlSAX2EntityDecl(ctx: *mut libc::c_void, name: *const xmlChar,
    ...
    #[no_mangle]
    fn htmlCreateMemoryParserCtxt(buffer: *const libc::c_char,
 ...
 */
    #[no_mangle]
    fn xmlCatalogAddLocal(catalogs: *mut libc::c_void, URL: *const xmlChar)
                          -> *mut libc::c_void;
    #[no_mangle]
 ...
 ************************************************************************/
    #[no_mangle]
    fn xmlGenericErrorDefaultFunc(ctx: *mut libc::c_void,
                                  msg: *const libc::c_char, _: ...);
    //  #[no_mangle]
    ...
    #[no_mangle]
    fn xmlParserInputGrow(_: xmlParserInputPtr,
                                          _: libc::c_int) -> libc::c_int;

    #[no_mangle]
    fn xmlGetIntSubset(_: *const xmlDoc) -> xmlDtdPtr;
    #[no_mangle]
    fn xmlSwitchEncoding(_: xmlParserCtxtPtr,
                                         _: xmlCharEncoding) -> libc::c_int;
    #[no_mangle]
    fn xmlSwitchToEncoding(_: xmlParserCtxtPtr,
                                           _: xmlCharEncodingHandlerPtr)
                                           -> libc::c_int;
    #[no_mangle]
    fn xmlParserInputShrink(_: xmlParserInputPtr);
    #[no_mangle]
    fn xmlCopyChar(_: libc::c_int, _: *mut xmlChar,
                                   _: libc::c_int) -> libc::c_int;
    #[no_mangle]
    fn xmlNextChar(_: xmlParserCtxtPtr);
    #[no_mangle]
    fn xmlParserAddNodeInfo(_: xmlParserCtxtPtr,
                                            _: xmlParserNodeInfoPtr);
    #[no_mangle]
    fn nodePop(_: xmlParserCtxtPtr) -> xmlNodePtr;
    #[no_mangle]
    fn xmlParseCharEncoding(_: *const libc::c_char)
                                            -> xmlCharEncoding;
    #[no_mangle]
    fn xmlPopInput(_: xmlParserCtxtPtr) -> xmlChar;
    #[no_mangle]
    fn xmlStrncasecmp(_: *const xmlChar, _: *const xmlChar,
                                      _: libc::c_int) -> libc::c_int;
    #[no_mangle]
    fn __htmlDefaultSAXHandler() -> *mut xmlSAXHandlerV1;
    #[no_mangle]
    fn inputPush(_: xmlParserCtxtPtr, _: xmlParserInputPtr)
                                 -> libc::c_int;
    #[no_mangle]
    ...
    #[no_mangle]
    fn xmlNewInputStream(_: xmlParserCtxtPtr)
                                         -> xmlParserInputPtr;
    #[no_mangle]
    fn xmlInitParser();
    #[no_mangle]
    fn xmlNewStringInputStream(_: xmlParserCtxtPtr,
                                               _: *const xmlChar)
                                               -> xmlParserInputPtr;
    #[no_mangle]
    ...
    #[no_mangle]
    fn xmlNewIOInputStream(_: xmlParserCtxtPtr,
    ...
    #[no_mangle]
    fn xmlCreateMemoryParserCtxt(_: *const libc::c_char,
                                                 _: libc::c_int)
                                                 -> xmlParserCtxtPtr;
    #[no_mangle]
