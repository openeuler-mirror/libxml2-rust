...
#[no_mangle]
pub extern "C" fn htmlTagLookup_rust(mut tag: *const xmlChar) -> *const htmlElemDesc {
...
#[no_mangle]
pub extern "C" fn htmlAutoCloseTag_rust(
    mut doc: htmlDocPtr,
...
#[no_mangle]
pub extern "C" fn htmlIsAutoClosed_rust(mut doc: htmlDocPtr, mut elem: htmlNodePtr) -> libc::c_int {
...
#[no_mangle]
pub extern "C" fn htmlIsScriptAttribute_rust(mut name: *const xmlChar) -> libc::c_int {
...
#[no_mangle]
pub extern "C" fn htmlEntityLookup_rust(mut name: *const xmlChar) -> *const htmlEntityDesc {
...
#[no_mangle]
pub extern "C" fn htmlEntityValueLookup_rust(mut value: libc::c_uint) -> *const htmlEntityDesc {
...
#[no_mangle]
pub extern "C" fn UTF8ToHtml_rust(
...
#[no_mangle]
pub extern "C" fn htmlEncodeEntities_rust(
    mut out: *mut libc::c_uchar,
    mut outlen: *mut libc::c_int,
    mut in_0: *const libc::c_uchar,
    mut inlen: *mut libc::c_int,
...
#[no_mangle]
pub extern "C" fn htmlNewDocNoDtD_rust(
...
#[no_mangle]
pub extern "C" fn htmlNewDoc_rust(
    mut URI: *const xmlChar,
    mut ExternalID: *const xmlChar,
) -> htmlDocPtr {
...
#[no_mangle]
pub extern "C" fn htmlParseEntityRef_rust(
...
#[no_mangle]
pub extern "C" fn htmlParseCharRef_rust(mut ctxt: htmlParserCtxtPtr) -> libc::c_int {
...
#[no_mangle]
pub extern "C" fn htmlParseDocument_rust(mut ctxt: htmlParserCtxtPtr) -> libc::c_int {
...
#[no_mangle]
pub extern "C" fn htmlCreateMemoryParserCtxt_rust(
...
#[no_mangle]
pub extern "C" fn htmlParseChunk_rust(
    mut ctxt: htmlParserCtxtPtr,
...
#[no_mangle]
pub extern "C" fn htmlCreatePushParserCtxt_rust(
...
#[no_mangle]
pub extern "C" fn htmlSAXParseDoc_rust(
...
#[no_mangle]
pub extern "C" fn htmlParseDoc_rust(
    mut cur: *const xmlChar,
    mut encoding: *const libc::c_char,
) -> htmlDocPtr {
...
#[no_mangle]
pub extern "C" fn htmlCreateFileParserCtxt_rust(
    mut filename: *const libc::c_char,
    mut encoding: *const libc::c_char,
) -> htmlParserCtxtPtr {
...
#[no_mangle]
pub extern "C" fn htmlSAXParseFile_rust(
    mut filename: *const libc::c_char,
    mut encoding: *const libc::c_char,
    mut sax: htmlSAXHandlerPtr,
    mut userData: *mut libc::c_void,
...
#[no_mangle]
pub extern "C" fn htmlParseFile_rust(
    mut filename: *const libc::c_char,
    mut encoding: *const libc::c_char,
) -> htmlDocPtr {
...
#[no_mangle]
pub extern "C" fn htmlHandleOmittedElem_rust(mut val: libc::c_int) -> libc::c_int {
...
#[no_mangle]
pub extern "C" fn htmlElementAllowedHere_rust(
...
#[no_mangle]
pub extern "C" fn htmlElementStatusHere_rust(
    mut parent: *const htmlElemDesc,
...
#[no_mangle]
pub extern "C" fn htmlAttrAllowed_rust(
    mut elt: *const htmlElemDesc,
...
#[no_mangle]
pub extern "C" fn htmlNodeStatus_rust(node: htmlNodePtr, mut legacy: libc::c_int) -> htmlStatus {
...
#[no_mangle]
pub extern "C" fn htmlCtxtUseOptions_rust(
    mut ctxt: htmlParserCtxtPtr,
...
#[no_mangle]
pub extern "C" fn htmlReadDoc_rust(
    mut cur: *const xmlChar,
...
#[no_mangle]
pub extern "C" fn htmlReadFile_rust(
    mut filename: *const libc::c_char,
    mut encoding: *const libc::c_char,
    mut options: libc::c_int,
) -> htmlDocPtr {
...
#[no_mangle]
pub extern "C" fn htmlReadMemory_rust(
    mut buffer: *const libc::c_char,
    mut size: libc::c_int,
    mut URL: *const libc::c_char,
    mut encoding: *const libc::c_char,
...
#[no_mangle]
pub extern "C" fn htmlReadIO_rust(
...
#[no_mangle]
pub extern "C" fn htmlCtxtReadDoc_rust(
    mut ctxt: htmlParserCtxtPtr,
    mut cur: *const xmlChar,
    mut URL: *const libc::c_char,
    mut encoding: *const libc::c_char,
...
#[no_mangle]
pub extern "C" fn htmlCtxtReadFile_rust(
    mut ctxt: htmlParserCtxtPtr,
    mut filename: *const libc::c_char,
    mut encoding: *const libc::c_char,
    mut options: libc::c_int,
...
#[no_mangle]
pub extern "C" fn htmlCtxtReadMemory_rust(
    mut ctxt: htmlParserCtxtPtr,
    mut buffer: *const libc::c_char,
    mut size: libc::c_int,
    mut URL: *const libc::c_char,
...
#[no_mangle]
pub extern "C" fn htmlCtxtReadFd_rust(
    mut ctxt: htmlParserCtxtPtr,
    mut fd: libc::c_int,
    mut URL: *const libc::c_char,
    mut encoding: *const libc::c_char,
...
#[no_mangle]
pub extern "C" fn htmlCtxtReadIO_rust(
    mut ctxt: htmlParserCtxtPtr,
    mut ioread: xmlInputReadCallback,
    mut ioclose: xmlInputCloseCallback,
    mut ioctx: *mut libc::c_void,
...
#[no_mangle]
pub extern "C" fn htmlParseTryOrFinish_rust(
    mut ctxt: htmlParserCtxtPtr,
    mut terminate: libc::c_int,
) -> libc::c_int {
...
#[no_mangle]
pub extern "C" fn htmlParseLookupSequence_rust(
    mut ctxt: htmlParserCtxtPtr,
    mut first: xmlChar,
    mut next: xmlChar,
    mut third: xmlChar,
